...
function Footer() {
  return (
    <>
      <div className="grid md:grid-cols-10 grid-cols-1 p-5 gap-y-5 bg-mainGray text-white">
        ...
        <div className="md:col-span-5 col-span-1 flex md:items-start items-center flex-col justify-center  ">
          ...
          <p className="custom-text-lg md:text-start text-center font-semibold space-x-2">
