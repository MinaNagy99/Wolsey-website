...
function FounderOfJourney() {
  const data = {
    ...
    normalText: [
      "Danny Wolsey, LEED AP, P.Eng., founded Wolsey Structural Engineering Ltd. in 2006 following a distinguished career collaborating with leading engineers on high-profile projects worldwide. In mid-2023, Wolsey Structural Engineering proudly joined Mosaic Holding Corporation as a subsidiary.",
      "His experiences span across 4 continents, contributing to high-profile projects in more than 10 countries across the globe. With a diverse portfolio ranging from institutional and commercial projects to entertainment and residential designs, Danny has developed a profound understanding of complex structural challenges, always prioritising practical, innovative, and sustainable solutions.",
  ...
  return (
    <>
      <div className="grid lg:grid-cols-4  grid-cols-1 ">
        ...
        <div className="lg:col-span-3 col-span-1 py-5 my-auto ">
